  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-4">
        <div className="px-6 py-6 flex items-center gap-5">
          ...
          <div className="relative flex-shrink-0">
            {userData.image ? (
              ...
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-400 to-purple-600 flex items-center justify-center shadow-md shadow-violet-200">
          ...
          <Link
            ...
            className="flex-shrink-0 w-9 h-9 bg-gray-100 hover:bg-violet-50 hover:border-violet-200 border border-transparent rounded-xl flex items-center justify-center transition-all group"
          >
        ...
        {/* Email row */}
        {userData.email && (
          <div className="flex items-center gap-3 px-6 py-3.5 border-t border-gray-50">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 font-medium">{userData.email}</p>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-50">
          <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider">Session</h3>
        </div>
