    ...
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-xs text-gray-400 dark:text-violet-300 uppercase tracking-wide font-semibold">Ready to Train</p>
      ...
      <div className="bg-white dark:bg-slate-900 dark:border-gray-800 rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-5">
        <div className="px-6 py-5">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            {[
              ...
              <div key={s.label} className="text-center bg-gray-50 dark:bg-slate-800 rounded-xl py-3">
                <p className="text-lg font-bold text-gray-900 dark:text-violet-100">{s.value}</p>
          ...
          <button
            onClick={onStart}
            className="w-full flex items-center justify-center gap-2.5 bg-violet-600 hover:bg-violet-700 active:scale-[0.98] text-white font-bold text-sm py-3.5 rounded-xl shadow-md shadow-violet-200 dark:shadow-purple-700 transition-all"
          >
